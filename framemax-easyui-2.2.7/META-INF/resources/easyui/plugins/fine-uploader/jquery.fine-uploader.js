...
(function(global) {
    ...
    qq.PasteSupport = function(o) {
        ...
        function registerPasteHandler() {
        	if(!(qq.chrome() || qq.opera())){
        		registerPasteHandlerEx();
        		return;
        	}
        ...
        function registerPasteHandlerEx() {
        	var jq = $(options.targetElement);
        	var el = createHiddenEditable().appendTo(jq);
        	...
        	el.on('paste',function(ev){
                var clipboardData, file, item, j, k, len, len1, ref, ref1, ref2, ref3;
                ...
                if (clipboardData && clipboardData.files && clipboardData.files.length) {
                    ...
                    for (k = 0, len1 = ref3.length; k < len1; k++) {
                      file = ref3[k];
                      options.callbacks.pasteReceived(file);
                      break;
                    }
                }
                return null;                
